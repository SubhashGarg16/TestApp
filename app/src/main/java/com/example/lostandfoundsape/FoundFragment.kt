...
import com.example.lostandfoundsape.Adapters.RecyclerViewAdapterF
...
class FoundFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //found_rec_view.layoutManager = LinearLayoutManager(context)




    }
    private fun DummyList(size: Int): List<FoundFragmentItem>{

        val list = ArrayList<FoundFragmentItem>()
